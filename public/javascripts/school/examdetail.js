layui.use('table', function(){
    ...
    table.render({
        elem: '#demo'
        ,cellMinWidth: 80
        ,url: '/school/exam/see/examdetail/table?time='+new Date().getTime() //数据接口
        ,page: true //开启分页
        ,cols: [[ //表头
            ...
            //,{field: 'down', title: '操作', width: 150,templet:'<div><a href="examdetail/persondown?id={{ d.id}}" class="downs">下载试卷</a></div>'}
        ]]
        ,limit:10
        ,limits:[10,20,30,40,50]
        ,id: 'testReload'
    });
    // 学生考试记录:用户名:username;班级:school;名称:exam;分数:score
